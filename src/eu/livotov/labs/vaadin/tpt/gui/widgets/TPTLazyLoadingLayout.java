 ...
 */
package eu.livotov.labs.vaadin.tpt.gui.widgets;
...
public class TPTLazyLoadingLayout extends VerticalLayout implements Runnable
{
    ...
    protected void activateErrorView(Throwable err)
    {
    ...
    protected void activateLoadingView()
    {
        ...
        // This is workaround to ticket #14 at googlecode: http://code.google.com/p/tpt/issues/detail?id=14
